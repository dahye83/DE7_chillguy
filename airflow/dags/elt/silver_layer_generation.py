...
# SQL 폴더 및 파일 정의
SQL_FOLDER = Path("/opt/airflow/sql/silver")
SQL_FILES = [
    "SL_AIRPORT_SCHEDULE_YEARLY.sql",
    "UPDATE_AIRPORT_SCHEDULE_STATIC_YEARLY.sql",
    "SL_WORLD_AIRPORTS_INFO_STATIC.sql",
    "SL_AIRPORT_SCHEDULE_STATIC_YEARLY_JOINED.sql",
]
...
with DAG(
    dag_id="silver_layer_generation",
